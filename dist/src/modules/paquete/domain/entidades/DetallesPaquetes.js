...
export const detallesGrow = {
    ...
    almacenamientoAdicional: '0,500 USD por GB al mes sobre  20 GB máximo 100 GB',
    horasDesarrolloExtras: 'No incluido',
};
export const detallesInstitutional = {
    // implementacion
...
export const detallesManufacturing = {
    // implementacion
    costoActivacion: 19000,
...
export const detallesEnterprise = {
    // implementacion
    ...
    maxSucursales: 100,
    maxEmpleados: 999,
    diasDeAsesorCapacitacion: 'Arquitecto de exito asignado  para garantizar la transformacion',
    usuariosIncluidosCapacitacion: '20 ',
...
export const detallesInternationalEnterprise = {
    // implementacion
    ...
    horasDisponibleSemanalesCapacitacion: 'Contacte a ventas para mayor informacion',
